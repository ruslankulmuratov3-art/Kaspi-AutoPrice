...
class PriceListService:
    """Create Kaspi Excel price lists without calling the product import API.

    Самый безопасный режим: взять скачанный из кабинета Kaspi прайс-лист как шаблон,
    поменять только колонку price по нужным SKU и оставить остальные колонки как были.
    """
    ...
    def build_xlsx(
        ...
        *,
        ...
        return self._build_minimal(products, price_by_sku)
